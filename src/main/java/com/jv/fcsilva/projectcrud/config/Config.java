...
public class Config implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null,Instant.parse("2022-01-20T13:54:07Z"), u1);
        Order o2 = new Order(null, Instant.parse("2022-01-20T13:54:07Z"), u2);
        Order o3 = new Order(null,Instant.parse("2022-01-20T13:54:07Z"), u1);
